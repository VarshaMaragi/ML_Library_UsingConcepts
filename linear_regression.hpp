...
public:
	...
	double obj(vector<double> beta, vector<vector<double>> train_data, vector<double> train_labels)
	{
	...
	vector<double> regress(vector<vector<double>> test_data)
	{
		...
		vector<double> predicted_values(test_data.size());
