#ifndef LIBML_LASSO_REGRESSION_HPP
#define LIBML_LASSO_REGRESSION_HPP
...
public:
	...
	// The Lasso Regression Objective value
...
std::ostream& operator<<(std::ostream& os, const LassoRegression& lr) {
...
std::istream& operator>>(std::istream& is, LassoRegression& lr) {
...
#endif // ifndef LIBML_Lasso_REGRESSION_HPP
